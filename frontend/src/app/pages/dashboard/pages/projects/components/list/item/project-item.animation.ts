...
export const ContentAnimation = trigger('content', [
  ...
  state('highlight', style({ 'border-left': '0.5em solid #e6e6e6', background: 'rgb(243, 244, 245, .5)' })),
  state('selected', style({ 'border-left': '0.5em solid #9e9ac8', background: 'rgb(243, 244, 245, .5)' })),
  state('deleting', style({ 'border-left': '0.5em solid #e34a33', background: 'rgb(243, 244, 245, .5)', opacity: 0.4 })),
  state('updating', style({ 'border-left': '0.5em solid #fdcc8a', background: 'rgb(243, 244, 245, .5)', opacity: 0.4 })),
